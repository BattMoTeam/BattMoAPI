...
#
function get_defaults(conn::ClientConnection)
	try
		@info "Getting meta data for client $(conn.id)."

		cell_parameter_defaults = ["chayambuka_2022", "chen_2020", "xu_2015"]
		cycling_protocol_defaults = ["cc_charge", "cc_cycling", "cc_discharge", "cccv"]
		model_settings_defaults = ["p2d"]
